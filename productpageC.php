...
<section id="header">
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="img/Choco.png" width="100%" id="MainImg"alt="">
    
            <div class="small-img-group">
                <div class="small-img-col">
                <img src="img/Choco.png" width="100%" id="small-img"alt="">
                </div>
                <div class="small-img-col">
                <img src="img/chc.png" width="100%" id="small-img"alt="">
                </div>
                <div class="small-img-col">
    ...
    <div class="single-pro-details">
        ...
        <select id="mySelect" onchange="redirectToPage(this)">
            <option>#54669 Choco Tart</option>
