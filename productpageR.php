...
<section id="header">
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="img/Red.png" width="100%" id="MainImg"alt="">
    
            <div class="small-img-group">
                <div class="small-img-col">
                <img src="img/Red.png" width="100%" id="small-img"alt="">
                </div>
                <div class="small-img-col">
                <img src="img/Rd.png" width="100%" id="small-img"alt="">
                </div>
                <div class="small-img-col">
    ...
    <div class="single-pro-details">
       ...
       <label for="color-select">Choose a color:</label>
        <select id="mySelect" onchange="redirectToPage(this)">
            <option>#43360 Red Velvet</option>
