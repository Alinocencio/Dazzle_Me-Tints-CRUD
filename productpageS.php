...
<section id="header">
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="img/Sugar1.png" width="100%" id="MainImg"alt="">
    
            <div class="small-img-group">
                <div class="small-img-col">
                <img src="img/Sugar1.png" width="100%" id="small-img"alt="">
                </div>
                <div class="small-img-col">
                <img src="img/Sg.png" width="100%" id="small-img"alt="">
                </div>
                <div class="small-img-col">
    ...
    <div class="single-pro-details">
        ...
        <select id="mySelect" onchange="redirectToPage(this)">
            <option>#15256 Sugar Plum</option>
