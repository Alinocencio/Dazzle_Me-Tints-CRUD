...
<section id="header">
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="img/Peach.png" width="100%" id="MainImg"alt="">
    
            <div class="small-img-group">
                <div class="small-img-col">
                <img src="img/Peach.png" width="100%" id="small-img"alt="">
                </div>
                <div class="small-img-col">
                <img src="img/Pch.png" width="100%" id="small-img"alt="">
                </div>
                <div class="small-img-col">
    ...
    <div class="single-pro-details">
        ...
        <select id="mySelect" onchange="redirectToPage(this)">
            <option>#26316 Peachy Smoothie</option>
            <option value="productpageS.php">#15256 Sugar Plum</option>
            <option value="productpageB.php">#38481 Berry Macaroon</option>
